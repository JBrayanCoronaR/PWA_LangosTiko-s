        ...
        <div className="conocenos-container">
            ...
            <div className="cards-container-cono">
                <div className="card-cono">
                    ...
                    <h3 className="card-title">Rodolfo</h3>
                    <p className="card-text">Chef principal del restaurante.</p>
                </div>
                <div className="card-cono">
                    <div className="card-image">
                        <img src="/images/chef1.jpg" alt="Imagen 2" />
                    </div>
                    <h3 className="card-title">Manuel</h3>
                    <p className="card-text">Chef encargado los fines de semana.</p>
                </div>
                <div className="card-cono">
                    <div className="card-image">
                        <img src="/images/chef1.jpg" alt="Imagen 3" />
                    </div>
                    <h3 className="card-title">Sonia</h3>
                    <p className="card-text">Chef de medio tiempo.</p>
                </div>
            </div>
